...
def main():
    ...
    parser.add_argument("--ai", action="store_true", help="Generate AI Forensic Summary")
    ...
    if args.ai:
        print(f"\n{Fore.MAGENTA}--- AI FORENSIC COPILOT SUMMARY ---")
        copilot = AICopilot()
        summary = copilot.generate_summary(results_tree)
